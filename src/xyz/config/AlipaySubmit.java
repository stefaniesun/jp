...
import xyz.util.httpClient.HttpProtocolHandler;
import xyz.util.httpClient.HttpRequest;
import xyz.util.httpClient.HttpResponse;
import xyz.util.httpClient.HttpResultType;
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	 for (String key : sPara.keySet()) {
        		   System.out.println("key= "+ key + " and value= " + sPara.get(key));
        		  }
        	mysign = EncryptionUtil.md5(prestr+AlipayConfig.key);//姚成成2015-07-20
